...
const BulkSubscriptionUpdatePage: NextPage = () => {
    ...
    <AdminLayout>
      <div className="py-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 mt-6">
          <Card>
            <CardHeader>
              <h2 className="text-xl font-semibold">Bulk Update Subscription Levels</h2>
              <p className="text-gray-600 mt-1">
                Update subscription levels for multiple worksheets at once. Filter worksheets, select them, and assign them to Free, Essential, or Premium subscription levels.
              </p>
            </CardHeader>
            <CardContent>
              {/* Filters */}
                          ...
                          <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            <div className="flex items-center">
                              <input
                                ...
                                disabled={isUpdating || worksheets.length === 0}
                        ...
                        <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                          ...
                          {Array.from({ length: Math.ceil(totalWorksheets / worksheetsPerPage) || 1 }).map((_, i) => (
                            <button
                              ...
                              className={`relative inline-flex items-center px-4 py-2 text-sm font-medium ${currentPage === i + 1 ? 'bg-orange-50 text-orange-600 z-10' : 'bg-white text-gray-500 hover:bg-gray-50'}`}
                            >
                              {i + 1}
                            </button>
...
export default withAuth(BulkSubscriptionUpdatePage, { adminOnly: true });
